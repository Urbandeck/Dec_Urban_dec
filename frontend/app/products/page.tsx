                  ...
                  >
                    <div className="aspect-square relative bg-stone-100 overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4 flex flex-col gap-2">
                        {index === 0 && (
                          <span className="bg-amber-500 text-white px-3 py-1 rounded-full text-xs font-semibold shadow-md">
                            BESTSELLER
                          </span>
                        )}
                        {product.rating >= 4.5 && (
                          <span className="bg-slate-800 text-white px-3 py-1 rounded-full text-xs font-semibold shadow-md">
                            TOP RATED
                          </span>
                        )}
                      </div>
                    ...
                    <div className="p-6">
                      {product.category && (
                        <span className="inline-block text-xs font-medium text-amber-700 bg-amber-50 px-2 py-1 rounded mb-3">
                          {product.category}
                        </span>
                      )}
