      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <div className="space-y-6">
            ...
            <div className="border-l-4 border-teal-500 pl-4">
              <h3 className="font-semibold text-lg mb-2 text-slate-700">How Shipping Charges Are Calculated</h3>
            ...
            {/* Estimated Charges */}
            <div className="border-l-4 border-teal-500 pl-4">
              <h3 className="font-semibold text-lg mb-2 text-slate-700">Estimated Shipping Charges</h3>
              <p className="text-slate-600">
            ...
            {/* Shipping Coverage */}
            <div className="border-l-4 border-teal-500 pl-4">
              <h3 className="font-semibold text-lg mb-2 text-slate-700">Shipping Coverage</h3>
            ...
            <div className="border-l-4 border-teal-500 pl-4">
              <h3 className="font-semibold text-lg mb-2 text-slate-700">Order Processing Time</h3>
              <p className="text-slate-600">
            ...
            {/* Delivery Timeline */}
            <div className="border-l-4 border-teal-500 pl-4">
              <h3 className="font-semibold text-lg mb-2 text-slate-700">Delivery Timeline</h3>
              <p className="text-slate-600">
            ...
            {/* COD Charges */}
            <div className="border-l-4 border-teal-500 pl-4">
              <h3 className="font-semibold text-lg mb-2 text-slate-700">Cash on Delivery (COD)</h3>
              <p className="text-slate-600">
            ...
            <div className="bg-amber-50 border-l-4 border-amber-500 p-4">
              <h3 className="font-semibold text-lg mb-2 text-slate-700">Important Notice</h3>
              <p className="text-slate-600">
            ...
            <div className="bg-red-50 border-l-4 border-red-500 p-4">
              <h3 className="font-semibold text-lg mb-2 text-slate-700">Return to Origin (RTO) Policy</h3>
              <p className="text-slate-600">
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-4 mb-6">
              <input
                ...
                className="flex-grow px-4 py-2 border border-stone-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500"
              />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {trackingSteps.map((step) => (
              <div key={step.status} className="flex items-start">
                ...
                <div>
                  <h4 className="font-semibold text-slate-700">{step.status}</h4>
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          <div className="flex items-center mb-6">
            <Globe className="text-amber-600 mr-3" size={32} />
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <div className="space-y-4">
            <details className="border-b pb-4">
              <summary className="cursor-pointer font-semibold text-slate-700 hover:text-teal-600">
        ...
        <div className="bg-gradient-to-r from-teal-600 to-teal-700 text-white rounded-lg p-8 text-center">
          ...
          <div className="flex justify-center">
            <Link href="/contact" className="px-6 py-3 bg-white text-teal-600 rounded-lg hover:bg-stone-100 transition font-semibold">
              Contact Support
            </Link>
          </div>
        </div>
