      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          <div className="flex items-center mb-6">
            <Shield className="text-slate-500 mr-3" size={32} />
          ...
          <div className="bg-stone-100 border border-stone-200 rounded-lg p-8">
            <div className="flex items-start mb-4">
              <AlertCircle className="text-slate-500 mt-1 mr-3 flex-shrink-0" size={28} />
              <div>
                <h3 className="font-bold text-xl mb-3 text-slate-700">No Warranty Provided</h3>
                ...
                <p className="text-slate-600">
                  ...
                  <Link href="/returns" className="text-amber-600 hover:underline font-semibold">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8 mb-8">
          ...
          <ul className="space-y-2 mb-6">
            <li className="flex items-start">
              ...
              <span className="text-slate-600">Product questions and setup guidance</span>
            </li>
            <li className="flex items-start">
              <span className="text-blue-500 mr-2">•</span>
              <span className="text-slate-600">Order status and shipping information</span>
            </li>
            <li className="flex items-start">
              <span className="text-blue-500 mr-2">•</span>
              <span className="text-slate-600">Return and exchange requests within 7 days</span>
            </li>
            <li className="flex items-start">
              <span className="text-blue-500 mr-2">•</span>
              <span className="text-slate-600">General troubleshooting advice</span>
            </li>
          </ul>
        ...
        <div className="bg-gradient-to-r from-gray-700 to-gray-900 text-white rounded-lg p-8 text-center">
          ...
          <div className="flex justify-center gap-4">
            <Link href="/contact" className="px-6 py-3 bg-white text-slate-700 rounded-lg hover:bg-stone-100 transition font-semibold">
              Contact Support
            </Link>
