        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/press" className="text-gray-600 hover:text-gray-900 transition">
                  Press
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/returns" className="text-gray-600 hover:text-gray-900 transition">
                  Returns
                </Link>
              </li>
              <li>
                <Link href="/warranty" className="text-gray-600 hover:text-gray-900 transition">
                  Warranty
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/sitemap" className="text-gray-600 hover:text-gray-900 transition">
                  Sitemap
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-600 text-sm">
              © 2024 Digital Frames Shop. All rights reserved.
            </p>
